...
เพิ่มปุ่ม "สำรองข้อมูล" และ "นำเข้าข้อมูล" ให้เรียบร้อยแล้วครับ!
วิธีใช้งาน:
ไปที่แท็บ "ข้อมูลส่วนตัว & เป้าหมาย"
เลื่อนลงมาด้านล่างสุด จะพบส่วนใหม่ชื่อว่า "จัดการข้อมูล (สำรอง/นำเข้า)"
ปุ่มสำรองข้อมูล: เมื่อกดแล้ว ระบบจะดาวน์โหลดไฟล์ .json เก็บไว้ในเครื่องของคุณ (คุณสามารถนำไฟล์นี้ไปแนบอีเมลส่งให้ตัวเองได้)
ปุ่มนำเข้าข้อมูล: หากต้องการเปลี่ยนเครื่องหรือกู้คืนข้อมูล ให้กดปุ่มนี้แล้วเลือกไฟล์ .json ที่เคยสำรองไว้ ข้อมูลทั้งหมดจะกลับมาทันทีครับ
